// This file was taken from https://raw.githubusercontent.com/termux/termux-app/refs/heads/master/terminal-emulator/src/main/jni/termux.c
// It is licensed under the GPLv3 license all rights are reserved to the original authors.
// I didn't want to download the file on build time, as the URL may change in the future, so I just copied the file here to make sure it is always available.
